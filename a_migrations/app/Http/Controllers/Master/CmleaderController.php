...
class CmleaderController extends Controller
{
    ...
    {
        return view('master.cmleader.index');
    }
    ...
    {
        return view('master.cmleader.create');
    }
    ...
    {
        $getResult = OoapMasCmleader::find($id);
        return view('master.cmleader.edit', ['dataCmleader' => $getResult]);
    }
    ...
    {
        $checkResult = OoapMasCmleader::find($id);
        ($checkResult->in_active == 1) ? $in_active = 0 : $in_active = 1;
        // dd($in_active);
        OoapMasCmleader::where('id', $id)->update([
            'in_active' => $in_active,

...
class Report7Component extends Component
{
    function submit()
    {
    ...
    {
        $this->datas = OoapTblBudgetProjectplanPeriod::getDatas()->get()->toArray();
    ...
    public function render()
    {
        ...
        return view('livewire.report.report7-component');
    }
    ...
    function clearArea($rang = NULL)
    {
        ...
        foreach ($this->datas as $kd => $vd) {
            ...
            $this->year_list['ปี' . $vd['budgetyear']] = 'ปี' . $vd['budgetyear'];


            if (!empty($year)) {

                if ($vd['budgetyear'] != $year) {
                    continue;
                }
            }
    ...
    public function chart()
    {
        ...
        foreach ($this->clone_datas as $ka => $va) {
            ...
            if (!isset($keep['จำนวนกิจกรรมที่จัด'][$va['name']])) {
                $keep['จำนวนกิจกรรมที่จัด'][$va['name']] = 0;
            }

...
class AssessmentComponent extends Component
{
    ...
    public $total_amt, $resultForm, $c_status = false;
    ...
    {
        return redirect()->route('activity.assessment.index');
    }
    ...
    public function render()
    {
        ...
        return view('livewire.activity.assessment.assessment-component');
    }
}

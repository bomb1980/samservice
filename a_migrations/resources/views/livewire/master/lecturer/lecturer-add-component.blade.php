<div>
    <div class="col-lg-12">
        <div class="panel-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    ...
                    @if ($lecturer_nationalid)
                        {!! $check_thai_id == false
                            ? '<small class="text-danger"><i class="icon wb-close"></i> ไม่พบรหัสบัตรประชาชน</small>'
            ...
            <div class="form-group row">
                <label class="col-md-2 form-control-label">นามสกุล: <span class="text-danger">*</span></label>
                <div class="col-md-7">
                    {{ Form::text('lecturer_lname', null, [
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    {{ Form::text('lecturer_address', null, [

    ...
    <div class="col-lg-12">
        <div class="panel-body">
            ...
            {{-- <div class="form-group row" style="margin-top: 2%">
                <div class="col-md-3"></div>
                <label class="col-md-9" style="font-size: 1rem; padding: 0.429rem 0;">ชุดคำถามแบบให้คะแนน (1 น้อยสุด - 5
                    มากสุด)</label>
            </div> --}}
            ...
            {{-- <div class="form-group row">
                <div class="col-md-3"></div>
                <label class="col-md-1" style="font-size: 1rem; padding: 0.429rem 0;">กลุ่มคำถาม <span
                        class="text-danger">*</span></label>
                <div class="col-md-2">
                    {{ Form::text('Auto_ASSESS_HDR', null, [
                        'wire:model' => 'Auto_ASSESS_HDR',
                        'id' => 'Auto_ASSESS_HDR',
                        'class' => 'form-control',
                    ]) }}
                    @error('Auto_ASSESS_HDR')
                ...
                <div class="col-md-6 offset-md-3">
                    <table class="table table-bordered table-hover table-striped w-full dataTable"
                        ...
                        <tr style="background-color:#abe4ff">
                            ...
                            <th class="text-left" style="width:25%">กลุ่มคำถาม</th>
                        ...
                        @foreach ($ASSESS_DESCRIPTION_R_LIST as $key => $value)
                            <tr>
                                ...
                                <td class="text-left">{{ $Auto_ASSESS_HDR_list[$key] }}</td>

    ...
    <table class="table table-bordered table-hover table-striped w-full dataTable" id="Datatables">
        <thead>
            <tr>
                ...
                <th class="col-2">หัวข้อแบบประเมิน</th>
                <th class="col-2">ประเภทแบบประเมิน</th>
                <th class="col-2">ประเภทกิจกรรม</th>
                <th class="col">รายละเอียดแบบประเมิน</th>
    ...
    <script>
        ...
        function call_datatable(search) {
            var table = $('#Datatables').DataTable({
                ...
                dom: 'rtp<"bottom"i>',
                ajax: {
                    url: '{{ route('api.master.assessment_topic.list') }}',
                    type: 'GET',
                    data: {
                        token: '{{ csrf_token() }}'
                    },
                ...
                columns: [{
                    ...
                    {
                        data: 'assessment_topics_name',
                        name: 'assessment_topics_name',
                        className: "text-left",
                        orderable: true
                    },
                    {
                        data: 'activity_types_name',

<div>
                ...
                <table class="table table-bordered table-hover w-full dataTable" id="Datatables">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center" role="row">
                            ...
                            <td>{{ number_format($transfer_amt) }}</td>
                            <td>{{ number_format($getFiscalyear->budget_amt - $transfer_amt) }}</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
    ...
    <div class="form-group row d-flex justify-content-center">
        ...
        {!! link_to(route('manage.local_mng.index'), 'ยกเลิก', ['class' => 'btn btn-default btn-outline ml-4']) !!}
    </div>
    {!! Form::close() !!}
...
<script>
        ...
        function setYearValue($val) {
            @this.setYearValue($val);
            console.log($val);
        }

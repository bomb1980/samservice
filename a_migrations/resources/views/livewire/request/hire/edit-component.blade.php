                ...
                <div class="{{ $panel == 2 ? '' : 'd-none' }}">
                    ...
                    <div class="row form-group">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" wire:model="req_shortname" placeholder="ชื่อกิจกรรม" {{ $view }}></textarea>
                            @error('req_shortname')
                            <label class="text-danger">{{ $message }}</label>
                            @enderror
                        </div>
                    ...
                    <div class="row form-group">
                        <div class="col-md-6">
                            ...
                            <textarea rows="4" class="form-control" wire:model="req_desc" placeholder="รายละเอียดกิจกรรม" {{ $view }}>></textarea>
                            @error('req_desc')
                            <label class="text-danger">{{ $message }}</label>
                            @enderror
                        </div>
                    ...
                    <div class="row form-group">
                        <div class="col-md-6">
                            ...
                            <textarea rows="4" class="form-control" wire:model="req_remark" placeholder="หมายเหตุ" {{ $view }}>></textarea>
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-md-4">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-2 form-group">
                            <input type="number" min="1" oninput = "validity.valid||(value='')" class="form-control" placeholder="ตัวเลขจำนวน" wire:model="req_peopleno" {{ $view }}>
                            @error('req_peopleno')
                                <label class="text-danger">{{ $message }}</label>
                            @enderror
                        </div>
                    ...
                    <div class="row form-group">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" placeholder="ชื่อสถานที่" wire:model="req_buildname" {{ $view }}>
                            @error('req_buildname')
                                <label class="text-danger">{{ $message }}</label>
                            @enderror
                        </div>
                ...
                <div class="{{ $panel == 3 ? '' : 'd-none' }}">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-3 form-group">
                            ...
                            <input type="text" class="form-control" placeholder="หมู่" wire:model="req_moo" {{ $view }}>
                            @error('req_moo')
                                <label class="text-danger">{{ $message }}</label>
                            @enderror
                        </div>
                    ...
                    <div class="row form-group">
                        <div class="col-md-5">
                            ...
                            <textarea rows="4" class="form-control" wire:model="req_leadinfo" placeholder="ข้อมูลผู้นำชุมชน" {{ $view }}></textarea>
                            @error('req_leadinfo')
                                <label class="text-danger">{{ $message }}</label>
                            @enderror
                        </div>
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($formdisabled != true)
                                                    <button type="button" class="btn btn-danger"  onclick="destroy_old_array({{ $key }})">
                                    ...
                                    @foreach ($file_array as $key => $val)
                                        <tr>
                                            ...
                                            <td><button type="button" class="btn btn-danger" onclick="destroy_array({{ $key }})">
                                                    <i class="icon wb-trash"></i>
                                                </button>
                                            </td>
                                        </tr>
...
@push('js')
    ...
    <script>
        ...
        function submit_toconsider(number) {
            swal({
                title: "ยืนยันการ อัพเดทบันทึกส่งตรวจสอบ ?",
                icon: 'close',
                type: "warning",
                showCancelButton: true,
                confirmButtonText: 'ยืนยัน',

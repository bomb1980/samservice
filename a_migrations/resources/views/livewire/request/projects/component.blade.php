        ...
        <div class="page-header-actions">
            @if ($canRequest == 'open')
                <div class="btn-group btn-group-sm">
                    {{ link_to(route('request.hire.create'), ' คำขอทำโครงการจ้างงานเร่งด่วน', [
                        'class' => 'btn btn-primary float-right icon wb-plus',
                    ]) }}
                </div>
                <div class="btn-group btn-group-sm">
                    {{ link_to(route('request.train.create'), ' คำขอทำโครงการฝึกทักษะฝีมือ', [
                        'class' => 'btn btn-primary float-right icon wb-plus',
                    ]) }}
                </div>
            @endif
            ...
            <div class="panel-body container-fluid">
                <div class="row row-lg">
                    <div class="col-md-10 offset-md-1">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md" style="margin-bottom: 30px">
                                        <div data-click-state=0 name="selecter" id="select_1"
                                            onclick="onclick_select('#select_1', '#2F3644', 'selecter_1_text', 'บันทึกแบบร่าง', 1)"
                                            class="bomb-bt select-status1" style="border-radius: 25px;">
                                            <div class="card-block text-center">
                                                <h1 class="card-title"><img src="{{ asset('assets/images/9.png') }}"
                                                        width="60px;" alt="">
                                                </h1>
                                                <p glob_name="selecter_text" name="selecter_1_text"
                                                    class="h4 font-weight-bold", style="">บันทึกร่าง/ส่งกลับ</p>
                                                <p glob_name="selecter_text" name="selecter_1_text"
                                                    class="h5 font-weight-bold", style=""><span
                                                        id="selecC1">{{ $selecterC1 }}</span> รายการ
                                                </p>
                                                <p glob_name="selecter_text" name="selecter_1_text"
                                                    class="h5 font-weight-bold", style="">จำนวนเงิน <span
                                                        id="selecS1">{{ $selecterS1 }}</span></p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <a id="exelExport" href="{{ route('request.exel.request2_3.index', ['arr' => 'pop']) }}",
                            style="visibility: hidden">Exel</a>
                    </div>
                </div>
            </div>
        </div>

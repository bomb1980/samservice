        ...
        <div class="form-group col-md-10 panel">
            <div class="panel-body container-fluid">
                ...
                <div class="{{ $panel == 1 ? '' : 'd-none' }}">
                    ...
                    {{-- <div class="row form-group">
                        <div class="col-md-3">
                            <label class="form-control-label">งวดที่ <span class="text-danger">*</span></label>
                            {{ Form::select('act_periodno', $periodno_list, $act_periodno, [
                                'onchange' => 'setValue("act_periodno",event.target.value)',
                                'class' => 'form-control select2',
                                'placeholder' => '--งวดที่--',
                            ]) }}
                            @error('act_periodno')
    ...
    <script>
        ...
        window.onload = function() {
            ...
            Livewire.on('popup', ($act_number) => {
                swal({
                        title: "บันทึกคำขอปรับแผนเสร็จสิ้น",
                        type: "success",

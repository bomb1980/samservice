    ...
    <div class="row">
        ...
        <div class="form-group col-md-10 panel">
            <div class="panel-body container-fluid">
              ...
              {{-- <div class="row">
                    <div class="col-md-12 form-group text-center grid-container">
                        <button type="button"
                            class="btn btn-primary form-group {{ $panel == 1 ? '' : 'btn-outline' }}"
                            wire:click="changPanel(1)">ข้อมูลใบคำขอ
                            @if ($circle1 == true)
                                <span class="dot-checkmark text-center">
                                    <i></i>
                        ...
                        <button type="button"
                            class="btn btn-primary form-group {{ $panel == 2 ? '' : 'btn-outline' }}"
                            wire:click="changPanel(2)">ข้อมูลวิทยากรและผู้ร่วมกิจกรรม
                        </button>
                        <button type="button"
                            class="btn btn-primary form-group {{ $panel == 3 ? '' : 'btn-outline' }}"
                            wire:click="changPanel(3)">ข้อมูลกิจกรรม
                            @if ($circle2 == true)
                                <span class="dot-checkmark text-center">
                                    <i></i>
                                </span>
                        ...
                        <button type="button"
                            class="btn btn-primary form-group {{ $panel == 4 ? '' : 'btn-outline' }}"
                            wire:click="changPanel(4)">พื้นที่ดำเนินการ
                            @if ($circle3 == true)
                                <span class="dot-checkmark text-center">
                                    <i></i>
                                </span>
                        ...
                        <button type="button"
                            class="btn btn-primary form-group {{ $panel == 5 ? '' : 'btn-outline' }}"
                            wire:click="changPanel(5)">ค่าใช้จ่าย
                            @if ($circle4 == true)
                                <span class="dot-checkmark text-center">
                                    <i></i>
                                </span>
                        ...
                        <button type="button"
                            class="btn btn-primary form-group {{ $panel == 6 ? '' : 'btn-outline' }}"
                            wire:click="changPanel(6)">แนบไฟล์
                            @if ($circle5 == true)
                                <span class="dot-checkmark text-center">
                                    <i></i>
                                </span>

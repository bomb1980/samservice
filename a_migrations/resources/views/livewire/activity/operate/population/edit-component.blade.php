                    ...
                    <div class="col-md-12">
                        ...
                        @if ($pop_role == 1)
                            <div class="form-group row">
                                <label class="col-md-2 form-control-label">ประเภทวิทยากร </label>
                                <div class="col-md-3">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                {{ form::text('pop_welfarecard', $pop_welfarecard, [
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-md-2 form-control-label">วัน/เดือน/ปีเกิด</label>
                        ...
                        <div class="row form-group">
                            <label class="col-md-2 form-control-label">บ้านเลขที่</label>
                            <div class="col-md-3 form-group">
                        ...
                        @if ($pop_role == 1)
                            <div class="row form-group">
                                <label class="col-md-2 form-control-label">วุฒิการศึกษา</label>
                                <div class="col-md-3 form-group">
                        ...
                        @if ($pop_role == 2)
                            <div class="row form-group">
                                <label class="col-md-2 form-control-label">กลุ่มอาชีพหลัก</label>
                                <div class="col-md-3 form-group">
                                ...
                                <label class="col-md-2 form-control-label">รายได้ต่อเดือน</label>
                                <div class="col-md-3 form-group">
                            ...
                            <div class="form-group row">
                                <label class="col-md-2 form-control-label">ท่านเป็นผู้พิการใช่หรือไม่</label>
                                <div class="col-md-3">
                                    <div class="radio-custom radio-primary radio-inline">
                            ...
                            <div class="form-group row">
                                <label class="col-md-2 form-control-label">ท่านเป็นแรงงานนอกระบบใช่หรือไม่</label>
                                <div class="col-md-3">
                                    <div class="radio-custom radio-primary radio-inline">
    ...
    <script>
        ...
        function applications_thai_format(id, text) {
            ...
            if (check == parseInt(number.charAt(12))) {
                ...
                // @this.set('pop_nationalid', number);
            }
        }

        function phone_format(id, number) {
            text = number.replace(/(\d\d\d)(\d\d\d\d\d\d\d)/, "$1-$2");
            $("#" + id).val(text);
        }
    </script>
@endpush

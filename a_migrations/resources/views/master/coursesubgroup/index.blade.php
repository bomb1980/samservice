        ...
        <div class="page-header">
            ...
            <div class="page-header-actions">
                <div class="btn-group btn-group-sm">
                    {{ link_to(route('master.coursesubgroup.create'), ' เพิ่มข้อมูล', [
                        'class' => 'btn
                                    btn-primary btn-md
            ...
            <div class="panel">
                <div class="panel-body container-fluid">
                    <div class="row row-lg">
                        <div class="col-md-12">
                            @livewire('master.coursesubgroup.coursesubgroup-component')
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function call_datatable(search) {
            var table = $('#Datatables').DataTable({
                ...
                dom: 'rtp<"bottom"i>',
                ajax: {
                    url: '{{ route('api.master.coursesubgroup.list') }}',
                    type: 'GET',
                    data: {
                        token: '{{ csrf_token() }}'
                    },
                ...
                columns: [{
                    ...
                    {
                        data: 'coursegroup_name',
                        name: 'coursegroup_name',
                        className: "text-left",
                        orderable: true
                    },
                    {

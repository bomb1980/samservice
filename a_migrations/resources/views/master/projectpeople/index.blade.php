...
<div class="page">
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#" class="keychainify-checked">ข้อมูล Master สรจ.</a></li>
            <li class="breadcrumb-item active">บันทึกประวัติผู้เข้าร่วมโครงการ</li>
        </ol>
        <div class="page-header-actions">
            <div class="btn-group btn-group-sm">
                {{ link_to(route('master.projectpeople.create'),' เพิ่มประวัติผู้เข้าร่วมโครงการ',['class'=>'btn
                btn-primary btn-md
        ...
        <div class="panel">
            <div class="panel-body container-fluid">
                <div class="row row-lg">
                    <div class="col-md-12">
                        @livewire('master.projectpeople.projectpeople-index-component')
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function call_datatable(search) {
        var table = $('#Datatables').DataTable({
            ...
            dom: 'rtp<"bottom"i>',
            ajax: {
                url: '{{ route("api.master.projectpeople.list") }}',
                type: 'GET',
            ...
            columns: [
                ...
                { data: 'peoid', name: 'peoid', className: "text-left", orderable: true },
                { data: 'fullname', name: 'fullname', className: "text-left", orderable: true },
                { data: 'fulladdress', name: 'fulladdress', className: "text-left", orderable: true },
                { data: 'peolecmobile', name: 'peolecmobile', className: "text-left", orderable: true },

        ...
        <div class="panel">
            ...
            <div class="panel-body container-fluid">
                <div class="row row-lg">
                    ...
                    <div class="col-md-6">
                        {{ link_to(route('companies.create'), 'CREATE',['class'=>'btn btn-primary float-right']) }}
                    </div>
                </div>
                <div class="row row-lg">
                    <div class="col-md-12">
    ...
    function call_datatable(search) {
        var table = $('#Datatables').DataTable({
            ...
            columns: [
                ...
                { data: 'companies_name', name: 'companies_name', className: "text-left", orderable: false },

...
@section('content')
    <div class="page">
        <div class="page-header">
            <h1 class="page-title">โอนคืนส่วนกลาง</h1>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/') }}" class="keychainify-checked">หน้าแรก</a></li>
                <li class="breadcrumb-item"><a href="#" class="keychainify-checked">บริหารงบประมาณ</a></li>
                <li class="breadcrumb-item"><a href="{{ route('manage.local_mng.index') }}" class="keychainify-checked">บริหารงบประมาณส่วนถูมิภาค</a></li>
                <li class="breadcrumb-item active">โอนคืนส่วนกลาง</li>
            </ol>
            ...
            <div class="panel">
                <div class="panel-body container-fluid">
                    <div class="row row-lg">
                        <div class="col-md-12">
                            @livewire('manage.local-mng.tranbackcen-component')
                        </div>
                    </div>
                </div>
            </div>

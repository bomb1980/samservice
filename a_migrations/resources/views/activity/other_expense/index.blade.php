...
@section('content')
    {{-- <div class="page">
        <div class="page-header">
            <h1 class="page-title">บันทึกค่าใช้จ่ายอื่นๆ</h1>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/') }}" class="keychainify-checked">หน้าแรก</a></li>
                <li class="breadcrumb-item"><a href="#" class="keychainify-checked">บริหารกิจกรรม</a></li>
                <li class="breadcrumb-item active">บันทึกค่าใช้จ่ายอื่นๆ</li>
            </ol> --}}
            {{-- <div class="page-header-actions">
                <div class="btn-group btn-group-sm">
                    {{ link_to(route('activity.other_expense.create'), ' เพิ่มข้อมูล', [
            ...
            <div class="panel">
                <div class="panel-body container-fluid">
                    <div class="row row-lg">
                        <div class="col-md-12"> --}}
                            @livewire('activity.other-expense.other-expense-component')
                        {{-- </div>
                    </div>
                </div>
            </div>

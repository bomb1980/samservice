    ...
    <div class="page">
        <div class="page-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">บันทึกยืนยันความพร้อมคำขอการจัดสรรงบ (กิจกรรมจ้างงานเร่งด่วน)</li>
            </ol>
        ...
        <div class="page-content container-fluid">
            <div class="row row-lg">
                <div class="col-md-12">
                    @livewire('activity.ready-confirm.hire-edit-component', ['pullactivities' => $pullactivities])
                </div>
            </div>
        </div>
    </div>

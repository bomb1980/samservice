...
class CreateAaaTestsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aaa_tests', function (Blueprint $table) {
            $table->id(); $table->decimal('org_id', 20, 2)->default(0)->nullable();

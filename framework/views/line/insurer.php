          ...
          <div class="form-group row pl-5 pt-10">
            <div class="col-md-8 form-inline">
              ...
              ?>
                ...
                ?>
                  <button type="button" id="btnadd" name="btnadd" class="btn-primary btn waves-effect waves-classic" onclick="ajax_savepermission();">ดาวน์โหลด</button>
                <?php
                }
              } else {
                ?>
...
<script type="text/javascript">
  ...
  function ajax_savepermission() {
    ...
    var result = confirm("ต้องการดาวน์โหลดข้อมูลผู้ประกันตนตามเงื่อนไขที่เลือก ?");
    if (!result) {
      $("#btnadd").prop("disabled", false);
      return;
    }

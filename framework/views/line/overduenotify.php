    ...
    <div class="panel">
      <div class="panel-body container-fluid">
        ...
        <div class="form-group row pl-5 required" style="border-bottom: 1px solid #ebebeb;">
          <div class="col-md-8">
            <h3>การจัดการข้อความส่งถึงผู้ประกันตนค้างจ่ายเงินสมทบ</h3>
          </div>
        </div>
        <div class="content-wrap">
          ...
          <div id="op-group20" style="margin-top: 1.429rem;">
            ...
            <div class="form-group row pl-5 required form-inline">
              <label class="col-md-2 col-form-label control-label" style="justify-content: left;">ประเภท</label>

              <div class="col-md-8 form-inline">
                <?php
                $conn = Yii::$app->db;
                $sql = "SELECT * FROM mas_m39notitype WHERE status=1 ";
                ...
                ?>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="rdoselM39" id="rdoselM39<?php echo $row['id']; ?>" value="<?php echo $row['id']; ?>">
                    <label class="form-check-label" for="rdoselM39<?php echo $row['id']; ?>">
                      <?php echo $row['name']; ?>
                    </label>
                  </div>
                <?php
          ...
          <div id="op-group21" style="border-bottom: 1px solid #ebebeb; margin-top: 1.429rem;">
            ...
            <div class="form-group row pl-5 required form-inline">
              ...
              <label class="col-md-2 col-form-label control-label" style="justify-content: left;">รายการ</label>
              <div class="col-md-8 form-inline">
                <input type="text" class="form-control" id="line_subject" name="line_subject" value="<?php echo $subject; ?>" readonly>
                <label class="btn btn-primary col-md-2">
                  <i class="fa fa-image"></i> นำเข้าไฟล์ <input type="file" style="display: none;" id="uploadBtn" name="uploadBtn" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel, .csv, text/plain" onchange="checkfile(this)">
                </label>
              </div>
            ...
            <div class="col-md-8 form-inline">
              ...
              ?>
                  <div class="custom-control pr-20">
                    <button type="button" id="btnadd" name="btnadd" class="btn-primary btn waves-effect waves-classic" onclick="ajax_editpermission();">แก้ไขนำเข้า/ส่งออก</button>
                  </div>
                ...
                ?>
                  <button type="button" id="btnadd" name="btnadd" class="btn-primary btn waves-effect waves-classic" onclick="ajax_savepermission();">นำเข้า/ส่งออก</button>
                <?php
                }
              } else {
                ?>
          ...
          <table id="productTable1" class="table table-striped table-hover table-bordered tableUpdated">
            <thead>
              <tr>
                ...
                <th style='width:20%'>จำนวนนำเข้า</th>
                <th style='width:20%'>จำนวนที่ส่งออก</th>
              </tr>
            </thead>
            <tbody></tbody>
          </table>
...
<script type="text/javascript">
  ...
  function checkFields(type_id) {
    ...
    dataTable = $(tbel).DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "<?php echo Yii::$app->urlManager->createAbsoluteUrl("line/listoverduenotify"); ?>",
        "data": {
          'search': search,

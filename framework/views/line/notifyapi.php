  ...
  <div class="page-header">
    ...
    <div class="page-header-actions">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo Yii::$app->urlManager->createAbsoluteUrl("/line/listnotifyapi")  ?>">รายการ</a></li>
    ...
    <div class="panel">
      <div class="panel-body container-fluid">
        ...
        <div class="form-group row pl-5 required" style="border-bottom: 1px solid #ebebeb;">
          <div class="col-md-8">
            <h3>การจัดการข้อความส่งถึงผู้ประกันตน</h3>
          </div>
        </div>
...
<script type="text/javascript">
  ...
  function ajax_savepermission() {
    ...
    var result = confirm("ต้องการสร้างข้อความสำหรับส่งให้ผู้ประกันตน ?");
    if (!result) {
      $("#btnadd").prop("disabled", false);
      return;
    }
    ...
    $.ajax({
        url: "<?php echo Yii::$app->urlManager->createAbsoluteUrl("line/setnotify"); ?>",
        method: "POST",
        dataType: "json",
        data: {
      ...
      .done(function(data) {
        ...
        if (data.status == 'success') {
          $("#btnadd").prop("disabled", false);
          alert('เพิ่มข้อความสำหรับส่งให้ผู้ประกันตนเรียบร้อย');
...
?>
    ...
    <script type="text/javascript">
      function ajax_editpermission() {
        ...
        $.ajax({
            url: "<?php echo Yii::$app->urlManager->createAbsoluteUrl("line/editnotify"); ?>",
            method: "POST",
            dataType: "json",
            data: {
              id: <?php echo $id; ?>,
          ...
          .done(function(data) {
            ...
            if (data.status == 'success') {
              $("#btnadd").prop("disabled", false);
              alert('แก้ไขข้อความสำหรับส่งให้ผู้ประกันตนเรียบร้อย');
              window.location.href = '' + data.msg + '';
            } else {
              alert(data.msg);
              $("#btnadd").prop("disabled", false);

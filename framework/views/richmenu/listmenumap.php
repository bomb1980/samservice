          ...
          <div class="col-lg-auto" style="margin: 0 auto;max-width: 1200px;">
            ...
            <div class="form-inline">
              ...
              <div class="form-group form-material">
                ...
                if ($btnVisible) {
                ?>
                  <button type="button" onclick="location.href='<?php echo Yii::$app->urlManager->createAbsoluteUrl("richmenu/setview"); ?>';" class="btn btn-primary waves-effect waves-classic ml-5" name="btnCreate" id="btnCreate" title="สร้างชุดข้อมูล">สร้างชุดข้อมูล</button>
                <?php
                }
                ?>
              </div>
          ...
          <table id="productTable1" class="table table-striped table-hover table-bordered tableUpdated">
            <thead>
              <tr>
                <th style="width: 3%;">#</th>
                <th></th>
                <th scope="col" style='width:8%'>รหัส Rich menu</th>
                <th scope="col" style='width:10%'>ใช้สำหรับผู้ประกันตนมาตรา</th>
                <th style='width:30%'>สังกัดผู้ประกันตน</th>
...
<script type="text/javascript">
  ...
  function ajax_deldata(_this, id) {
    ...
    var result = confirm("ต้องการลบการอ้างอิง Richmenu กับ ผู้ประกันตน ?");
    if (!result) {
      $(_this).removeAttr('disabled');
      return;
    }

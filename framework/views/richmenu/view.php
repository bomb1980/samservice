	...
	<div class="page-header">
		...
		<div class="page-header-actions">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item atcitve">แก้ไข</li>
			</ol>
		</div>
	</div>
										...
										<div class="row">
											...
											<div class="col">
												<div class="form-group row pl-5 required">
													...
													<div class="col-md-8">
														<input type="text" id="menu_name" name="menu_name" class="form-control" placeholder="ชื่อเมนู" value="<?php echo $data[0]['description'] ?>">
													</div>
												</div>
												...
												<div class="form-group row pl-5 required">
													...
													<div class="col-md-8">
														...
														<textarea id="menu_json" name="menu_json" rows="10" cols="50" style="width: 100%;">
														<?php echo $data[0]['menudata'] ?>
														</textarea>
														<script>
															// The plugin
												...
												<div class="form-group row pl-5 required">
													...
													<div class="col-md-8">
														...
														<img id="preview" src="data:image/jpg;base64,<?php echo $data[0]['img']  ?>" alt="" style="height:200px" />
														<script>
												...
												<div class="form-group row pl-5">
													<div class="col-md-8">
														<input type="hidden" id="hdsetdefault" value="<?php echo $data[0]['setdefault']  ?>" >
														<button type="button" id="btnadd" name="btnadd" class="btn-primary btn waves-effect waves-classic" onclick="ajax_savedata();">แก้ไข Rich menu</button>

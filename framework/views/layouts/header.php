<nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
  ...
  <div class="navbar-header">
	...
	<div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
	  <img class="navbar-brand-logo" src="<?php echo Yii::$app->params['prg_ctrl']['logo_sq']; ?>"  title="<?php echo Yii::$app->params['prg_ctrl']['name']; ?>">
	  <!--span class="navbar-brand-text hidden-xs-down"> <?php echo Yii::$app->params['prg_ctrl']['name'].' ('.Yii::$app->params['prg_ctrl']['version'].')'; ?></span-->
	</div>
  ...
  <div class="navbar-container container-fluid">
	...
	<div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
	  ...
	  <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
		<li class="nav-item">
		  <a class="nav-link" href="javascript:void(0)" role="button" style="cursor:default;"> 
			<i class="icon wb-user" aria-hidden="true"></i> รหัสผู้ใช้ : <?php echo $cwebuser->getInfo('displayname'); ?>
		  </a> 
		</li>						
		<li class="nav-item">
		  <a class="nav-link" href="<?php echo Yii::$app->urlManager->createUrl('logout'); ?>" role="button">
		...
		*/ ?>
		...
		<li class="nav-item dropdown">
		  <a class="nav-link navbar-avatar" data-toggle="dropdown" href="#" aria-expanded="false"
			...
			<?php echo Yii::$app->user->getInfo('displayname'); ?>
